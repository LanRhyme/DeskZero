      ...
      >
        {settings.wallpaperCompatible && settings.globalBlur !== false && wallpaper && (
          ...
          >
            ...
            />
            <div 
              className="absolute inset-0 bg-white/60 dark:bg-[#1a1a1a]/70"
            />
          </div>
        )}
        ...
        {items.map((item, index) => {
          if (item.divider) {
            return <div key={index} className="h-px bg-black/5 dark:bg-white/10 my-1 mx-2" />
          }
            ...
            >
              <button
                ...
                className={cn(
                  ...
                  item.disabled ? "opacity-50 cursor-not-allowed text-gray-500 dark:text-gray-400" : "cursor-default text-gray-800 dark:text-gray-200"
                )}
              >
                ...
                <div className={cn("absolute top-0 z-50", showOnLeft ? "right-[calc(100%-4px)] pr-1" : "left-[calc(100%-4px)] pl-1")}>
                  ...
                  >
                    ...
                    {item.subItems!.map((subItem, subIndex) => {
                      if (subItem.divider) {
                        return <div key={subIndex} className="h-px bg-black/5 dark:bg-white/10 my-1 mx-2" />
                      }
                      return (
                        <button
                          key={subIndex}
                          ...
                          className={cn(
                            ...
                            "hover:bg-black/5 dark:hover:bg-white/10",
                            subItem.disabled ? "opacity-50 cursor-not-allowed text-gray-500 dark:text-gray-400" : "cursor-default text-gray-800 dark:text-gray-200"
                          )}
                        >
